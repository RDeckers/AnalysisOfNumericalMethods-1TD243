...
&= \left(v^1_0v^2_0 - v^1_Nv^2_N\right)
\end{align}
...
\begin{align}
  ...
  \drv[t]{} \norm{v}^2_{\hat H} &=  v^1_0v^2_0 - v^1_Nv^2_N +   2\beta_1\left(v_N^2\right)^2 + 2\beta_0\left(v_N^1v_N^2\right) + 2\alpha_0\left(v_0^1\right)^2 + 2\alpha_1\left(v_0^1v_0^2\right)
\end{align}
Which leads to a stability condition of
\begin{align}
  \beta_0 = \frac{1}{2},\;\alpha_1 = -\frac{1}{2},\nn
